# Parent-App
Android App group project Oct 2021 - Dec 2021. 
Parent App allow parents to manage their children's profiles, also includes: flip coins for settling disputes, and timer for timeout.
...
References:
Main_menu.java:
    custom card view tutorial - https://www.youtube.com/watch?v=7S7646Cymn0

save state:
    https://stackoverflow.com/questions/151777/how-can-i-save-an-activity-state-using-the-save-instance-state

main menu photos:
    https://illinoisearlylearning.org/answers/parent-child/
    https://manmantras.com/blog/child-behavior-that-show-your-child-is-in-stress
    https://www.marketplace.org/2021/01/21/why-do-books-have-prices-printed-on-them/
    https://photostockeditor.com/free-images/chilren
